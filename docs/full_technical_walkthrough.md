...
This is the detailed, phase-by-phase version of the project: every
pipeline stage with its exact command, what it writes, and its real
result. For a short overview and quick setup, see the main
[`README.md`](../README.md) — this doc is for anyone who wants the full
depth (a reviewer checking rigor, or a contributor reproducing a step).
...
final AUTO_HANDLE/ESCALATE decision with reason. See the main README's
[Run it](../README.md#run-it) section for screenshots and the run command.

## Glossary

Plain-English definitions for terms used throughout this project's docs:
...
- **Phase 20 — reproducibility check.** Verifying a fresh clone can
  ...
  [Data preparation](#data-preparation) steps, hasn't been done yet.
